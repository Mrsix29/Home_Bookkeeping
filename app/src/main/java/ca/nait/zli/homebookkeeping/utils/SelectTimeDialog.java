...
/*
* time dialog from dialog_time
* */
public class SelectTimeDialog extends Dialog implements View.OnClickListener {
    EditText hourEditText,minuterEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hourEditText = findViewById(R.id.dialog_time_edit_text_hour);
        minuterEditText = findViewById(R.id.dialog_time_edit_text_minute);
        datePicker = findViewById(R.id.dialog_time_date_picker);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dialog_time_btn_ensure:
                ...
                String hourStr = hourEditText.getText().toString();
                String minuteStr = minuterEditText.getText().toString();
                int hour = 0;
